...
namespace D4DataParser.ViewModels
{
    public class MainWindowViewModel : BindableBase
    {
        ...
        public string CoreTOCPath
        {
            ...
            {
                _coreTOCPath = value;
                RaisePropertyChanged(nameof(CoreTOCPath));
            }
        }
        ...
        private string GetAffixType(AffixMeta affixMeta)
        {
            ...
            if (affixMeta.eMagicType == 1 && hasLegendaryFilter)
            {
                affixType = "aspect";
            }
        ...
        private void RemoveUnwantedAffixes()
        {
            ...
            // Remove all "_Legendary_" affixes
            _affixInfoList.RemoveAll(a => a.IdName.Contains("_Legendary_"));

            // Remove all "_Unique_" affixes
            ...
            // Remove all "_Lesser" affixes
            _affixInfoList.RemoveAll(a => a.IdName.EndsWith("_Lesser"));

            // Remove all "_Greater" affixes
            _affixInfoList.RemoveAll(a => a.IdName.EndsWith("_Greater"));

            // Remove all "_Double" affixes
            _affixInfoList.RemoveAll(a => a.IdName.EndsWith("_Double"));
            ...
            // Remove all "_Scaled2H" affixes - Used by Rank(s) of affixes
            _affixInfoList.RemoveAll(a => a.IdName.EndsWith("_Scaled2H"));
